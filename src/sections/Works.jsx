    ...
    <section id="work" className="flex flex-col min-h-screen pb-20">
      ...
      >
        {projects.map((project, index) => (
          <Link to={project.href} key={project.id} target="_blank">
            <div
              id="project"
            ...
            >
              ...
              <div className="flex justify-between px-10 text-black transition-all duration-500 md:group-hover:px-12 md:group-hover:text-white">
                ...
                <MdOutlineArrowOutward className="md:size-6 size-5" />
              </div>
              {/* divider */}
              ...
              <div className="relative flex items-center justify-center px-10 md:hidden h-52">
                <img
                  src={project.image}
